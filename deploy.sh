...
# git push -f git@gitee.com:muyaCode/VitePressNotes.git main:gh-pages # 发布到Gitee
git push -f git@github.com:muyaCode/VitePressNotes.git main:gh-pages # 发布到GitHub
...
# echo "仓库地址：https://github.com/muyaCode/VitePressNotes"
